...
export async function getStaticProps({ params }) {
  const blogData1 = getAllJson("blog");
  const blogData2 = blogData1.find((i) => i.slug === params.slug);
  const blogData3 = await renderContent(blogData2);
